...
# Seed the 8 upstream tables required by agent tools
# (billing_monitoring_summary, telemetry_*, silver_*, gold_*, billing_disputes, billing_write_audit)
catalog = CATALOG  # helper expects `catalog` and `schema` variables
schema = SCHEMA

# COMMAND ----------

# MAGIC %run "./_helper_seed_upstream_tables"
